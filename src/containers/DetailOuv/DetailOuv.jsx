    ...
    <>
      ...
      <div>
        <DetailItem
          ...
          descriptif={
            props.ouv.descriptif
              ? props.ouv.classification.libbele
              : "Acune description"
          }
          ...
          classification={
            props.ouv.classification ? props.ouv.classification.libbele : ""
          }
          createdAt={
            props.ouv.anneePublication ? props.ouv.anneePublication : ""
          }
          auth={props.isAuth}
        />
...
const mapStateToProps = ({ ouv, statistics, auth }) => ({
  loading: ouv.loading,
  error: ouv.error,
  ouv: ouv.ouvs,
