  ...
  console.log(values)
    ...
    return (
      ...
      <label htmlFor="dateEntreeService">Entrée en service:</label>
       ...
       <div className="forme-group form-fields">
      <label htmlFor="nvInstruction">Niveau d'instruction du militaire</label>
      <Controller
              as={ReactSelect}
              options={[
                  {
      ...
      <Controller
        ...
        <div className="forme-group form-fields">
      <label htmlFor="specialite">Spécialité actuelle du militaire</label>
      <Controller
              as={ReactSelect}
              options={[
                  {
        ...
        <div className="forme-group form-fields">
      <label htmlFor="gradeActuelle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unité Actuelle&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <Controller
              as={ReactSelect}
              options={[
                  {
        ...
        <div className="forme-group form-fields">
      <label htmlFor="uniteActuelle">&nbsp;&nbsp;&nbsp; Grade Actuel&nbsp;&nbsp;&nbsp;</label>
      <Controller
              as={ReactSelect}
              options={[
                  {
      ...
      <Controller
        ...
        <div className="forme-group form-fields">
      <label htmlFor="origine">Origine&nbsp;&nbsp;&nbsp;du&nbsp;&nbsp;&nbsp;Militaire</label>
      <Controller
              as={ReactSelect}
              options={[
                  {
