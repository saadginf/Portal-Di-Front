...
const FormOu = (props) => {
  ...
  const onSubmit = (values) => {
    ...
    let ouv = {
      ...
      editeur: {
        id: values.editeur ? values.editeur.value : null,
      },
    };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <button onClick={autShow} className="btn btn-primary add-btn">
          Ajouter Auteur
        </button>
        <div className="forme-group form-fields">
        ...
        <div className="forme-group form-fields">
          ...
          <Controller
            ...
            control={control}
          />
          <button onClick={themeeShow} className="btn btn-primary add-btn">
            Ajouter Thème
          </button>
        </div>
        ...
        <div className="forme-group form-fields">
          ...
          <Controller
            ...
            control={control}
          />
          <button onClick={orShow} className="btn btn-primary add-btn">
            Ajouter Une Origine
          </button>
        </div>
        <div className="forme-group form-fields">
        ...
        <button onClick={typeShow} className="btn btn-primary add-btn">
          Ajouter Un type
        </button>
        <div className="forme-group form-fields">
          ...
          <Controller
            ...
            control={control}
          />
          <button onClick={classShow} className="btn btn-primary add-btn">
        ...
        <div className="forme-group form-fields">
          ...
          <Controller
            ...
            control={control}
          />
          <button onClick={editShow} className="btn btn-primary add-btn">
            Ajouter Un Editeur
          </button>
        </div>
      ...
      <ModalInfo
        ...
        trans={props.addClass}
        error={props.classError}
      />
      <ModalInfo
        title="Ajouter Un Editeur"
        show={showedit}
        handleClose={editClose}
        trans={props.addEditeur}
        error={props.editError}
      />
      <ModalInfo
        title="Ajouter Un Auteur"
        show={showaut}
        handleClose={autClose}
        trans={props.addAut}
        error={props.autError}
      />
    </>
  );
};
